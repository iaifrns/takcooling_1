  ...
  <PageTransition>
    <div className='w-screen mt-20 flex flex-col items-center bg-white '>
      ...
      <div className='h-400 pt-20 md:h-300 w-full flex flex-col items-center'>
        <div className='relative w-full lg:w-5/6 xl:w-4/5 2xl:w-3/4 py-20'>
      ...
      <div className='relative w-full h-200 bg-gray-300'>
        <form onSubmit={handleSubmit} className='absolute flex flex-col w-4/5 md:w-1/2 -top-50 right-[15%] md:right-[25%] md:h-150 border-t-primary border-4 border-l-white border-r-white border-b-white bg-gray-50 rounded-xl p-15 gap-8'>
