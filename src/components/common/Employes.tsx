...
const Employes = () => {
    ...
    return (
        <ScrollAnimation>
            <div className='w-full p-8 lg:w-4/5 flex flex-col items-center'>
                ...
                <div className='w-full grid grid-cols-1 md:grid-cols-2  lg:grid-cols-3  gap-8 py-10 justify-center'>
                    {employer.map((emplo) => {
                        return (
